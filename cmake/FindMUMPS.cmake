...
if(MUMPS_INCLUDE_DIR AND MUMPS_LIBRARY_DIR)
  ...
  message(STATUS "Found MUMPS: ${MUMPS_Z_LIBRARY}, ${MUMPS_C_LIBRARY}, ${MUMPS_D_LIBRARY}, ${MUMPS_COMMON_LIBRARY}, ${MUMPS_PORD_LIBRARY}, ${PARMETIS_LIBRARY}, ${METIS_LIBRARY}")

  # set(MUMPS_LIBRARIES ${MUMPS_Z_LIBRARY}
    # ${MUMPS_C_LIBRARY} ${MUMPS_D_LIBRARY} ${MUMPS_COMMON_LIBRARY} ${MUMPS_PORD_LIBRARY})
  set(MUMPS_LIBRARIES ${MUMPS_D_LIBRARY} ${MUMPS_Z_LIBRARY} ${MUMPS_COMMON_LIBRARY})
  set(MUMPS_LIBRARIES ${MUMPS_D_LIBRARY} ${MUMPS_Z_LIBRARY} ${MUMPS_COMMON_LIBRARY} ${PARMETIS_LIBRARY} ${METIS_LIBRARY})
